...
public:
  ...
  */
  GenericValue(Type type) {
    static const unsigned defaultFlags[7] = {
        kNull_Flag, kFalseFlag, kTrueFlag, kObjectFlag, kArrayFlag,
        kConstStringFlag, kNumberFlag | kIntFlag | kUintFlag | kInt64Flag |
  ...
  */
  ...
  /*! \param name A string value as name of member.
      ...
      \note The ownership of name and value will be transfered to this object if
     success.
  */
  GenericValue &AddMember(GenericValue &name, GenericValue &value,
    ...
    if (o.size >= o.capacity) {
      if (o.capacity == 0) {
        ...
        o.capacity *= 2;
        o.members =
            (Member *)allocator.Realloc(o.members, oldCapacity * sizeof(Member),
...
ambiguous, as 0 also mean a null pointer of const char* type.
...
\endcode
  ...
  */
  ...
  /*! \param value		The value to be appended.
      \param allocator	The allocator for allocating memory. It must be the same
     one use previously.
      \return The value itself for fluent API.
  ...
  */
  ...
  /*! Since rapidjson permits "\u0000" in the json string, strlen(v.GetString())
   * may not equal to v.GetStringLength().
  */
  ...
  */
  ...
  /*! This function adopts the GoF visitor pattern.
     ...
     which is a Handler.
          It can also be used to deep clone this value via GenericDocument,
...
private:
  ...
  Member *FindMember(const Ch *name) {
    ...
    Object &o = data_.o;
    for (Member *member = o.members; member != data_.o.members + data_.o.size;
         ++member)
...
private:
  ...
  friend class GenericReader<Encoding, Allocator>; // for Reader to call the
                                                   // following private handler
                                                   // functions
